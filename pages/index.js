  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center bg-gradient-to-r from-sky-900 via-sky-800 to-sky-900">
        ...
        <form onSubmit = {handleSubmit} className="flex flex-col text-center mb-5 w-[500px] items-start justify-center justify-items-stretch bg-cover bg-gradient-to-r from-sky-500 via-sky-400 to-sky-500 rounded-xl gap-[14px] mt-[15px]"> {/*pake form biar yg di dalam form bisa disubmit*/}
